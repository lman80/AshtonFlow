        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                Toggle(
                    ...
                    isOn: $appState.screenRecordingEnabled
                )
                Text("Optional and off by default. When on, \(AppName.displayName) sends a screenshot of your active window to the AI for better context, which requires Screen Recording permission. Dictation and Edit Mode work fully without it.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }

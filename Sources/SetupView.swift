...
class GitHubMetadataCache: ObservableObject {
    ...
    private let repoAPIURL = URL(string: "https://api.github.com/repos/lman80/AshtonFlow")!
    ...
    func fetchIfNeeded() async {
        ...
        do {
            ...
            if count > 0 {
                ...
                let stargazersURL = URL(string: "https://api.github.com/repos/lman80/AshtonFlow/stargazers?per_page=\(perPage)&page=\(lastPage)")!
            ...
            let contributorsURL = URL(string: "https://api.github.com/repos/lman80/AshtonFlow/contributors?per_page=15")!
            do {
